...
title_font = ('candara', 35)
text_font = ('candara', 25)
credit_font = ('candara', 15)
help_font = ('candara', 15)
elements_font = ('candara', 10)
general_pady = 10
entry_width = 250
txt_color = 'black'
txt_color_alt = '#FED0FF'
front = '#FF00E6'
back = '#001AFF'
ground = '#FF0000'
roof = '#00FF0A'
...
class Caterpillar:
    def __init__(self, jan):
        ...
        def mainscreen():
            ...
            desenhar = ctk.CTkButton(frame, text='Desenhar', font=text_font, text_color=txt_color, fg_color=desenhar_color, command=verify_room)
            ...
            calcular = ctk.CTkButton(frame, text='Calcular', font=text_font, text_color=txt_color, fg_color=calcular_color, command=calculate)
...
Feito isso, pressione o botão"""
        ...
        desenhar_help = ctk.CTkButton(topframe, text='Desenhar', font=text_font, text_color=txt_color, fg_color=desenhar_color)
...
da representação do canvas, e clicar no botão"""
        ...
        calcular_help = ctk.CTkButton(topframe, text='Calcular', font=text_font, text_color=txt_color, fg_color=calcular_color)
