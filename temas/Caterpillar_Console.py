...
text_font = ('system', 30)
credit_font = ('system', 15)
help_font = ('system', 15)
elements_font = ('system', 10)
general_pady = 10
entry_width = 250
txt_color = '#00FF0A'
txt_color_alt = 'black'
...
background = 'black'
entry_bg = background
iniciar_button = 'black'
desenhar_color = '#00FF0A'
...
class Caterpillar:
    def __init__(self, jan):
        ...
        help_button = ctk.CTkButton(window, text='?', text_color=txt_color, border_color=txt_color, border_width=1, font=title_font, width=25, fg_color=txt_color_alt, corner_radius=90, command=self.open_help)
        ...
        iniciar_app = ctk.CTkButton(frame, text='Iniciar', border_color=txt_color, border_width=1, fg_color=iniciar_button, font=title_font, text_color=txt_color, width=50, height=150, corner_radius=90, command=start_program)
...
- - - - - - - - - - - - - - - - - - - - - - - - - -"""
        ...
        resultados_label = ctk.CTkLabel(topframe, text=resultados, font=credit_font, text_color=txt_color, justify='center')
