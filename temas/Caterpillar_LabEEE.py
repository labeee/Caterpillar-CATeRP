...
title_font = ('SansSerif', 35)
text_font = ('SansSerif', 25)
credit_font = ('SansSerif', 15)
help_font = ('SansSerif', 15)
elements_font = ('SansSerif', 10)
general_pady = 10
entry_width = 250
txt_color = 'black'
txt_color_alt = '#A9D18E'
front = '#FF00E6'
back = '#001AFF'
ground = '#FF0000'
roof = '#00FF0A'
...
background = 'white'
entry_bg = background
iniciar_button = '#A9D18E'
desenhar_color = '#A9D18E'
calcular_color = '#A9D18E'
...
class Caterpillar:
    def __init__(self, jan):
        ...
        def mainscreen():
            ...
            largura_ambiente = ctk.CTkEntry(c_ambiente, placeholder_text='Largura (cm)', font=credit_font, width=250, text_color=txt_color, fg_color=entry_bg)
            largura_ambiente.pack(pady=general_pady)
            comprimento_ambiente = ctk.CTkEntry(c_ambiente, placeholder_text='Comprimento (cm)', font=credit_font, width=250, text_color=txt_color, fg_color=entry_bg)
            comprimento_ambiente.pack(pady=general_pady)
            altura_ambiente = ctk.CTkEntry(c_ambiente, placeholder_text='Altura (cm)', font=credit_font, width=250, text_color=txt_color, fg_color=entry_bg)
            ...
            x_coord = ctk.CTkEntry(c_posicao, placeholder_text='X (cm)', font=credit_font, width=250, text_color=txt_color, fg_color=entry_bg)
            x_coord.pack(pady=general_pady)
            y_coord = ctk.CTkEntry(c_posicao, placeholder_text='Y (cm)', font=credit_font, width=250, text_color=txt_color, fg_color=entry_bg)
            y_coord.pack(pady=general_pady)
            z_coord = ctk.CTkEntry(c_posicao, placeholder_text='Z (cm)', font=credit_font, width=250, text_color=txt_color, fg_color=entry_bg)
            ...
            desenhar = ctk.CTkButton(frame, text='Desenhar', font=text_font, text_color=background, fg_color=desenhar_color, command=verify_room)
            ...
            temp_frontal = ctk.CTkEntry(c_temp, placeholder_text='Frontal', font=credit_font, width=160, text_color=txt_color, fg_color=entry_bg)
            temp_frontal.grid(row=1, column=0, pady=general_pady, padx=general_pady)
            temp_lat_esq = ctk.CTkEntry(c_temp, placeholder_text='Lateral Esquerda', font=credit_font, width=160, text_color=txt_color, fg_color=entry_bg)
            temp_lat_esq.grid(row=2, column=0, pady=general_pady, padx=general_pady)
            temp_piso = ctk.CTkEntry(c_temp, placeholder_text='Piso', font=credit_font, width=160, text_color=txt_color, fg_color=entry_bg)
            temp_piso.grid(row=3, column=0, pady=general_pady, padx=general_pady)
            temp_posterior = ctk.CTkEntry(c_temp, placeholder_text='Posterior', font=credit_font, width=160, text_color=txt_color, fg_color=entry_bg)
            temp_posterior.grid(row=1, column=1, pady=general_pady, padx=general_pady)
            temp_lat_dir = ctk.CTkEntry(c_temp, placeholder_text='Lateral Direita', font=credit_font, width=160, text_color=txt_color, fg_color=entry_bg)
            temp_lat_dir.grid(row=2, column=1, pady=general_pady, padx=general_pady)
            temp_teto = ctk.CTkEntry(c_temp, placeholder_text='Teto', font=credit_font, width=160, text_color=txt_color, fg_color=entry_bg)
            ...
            calcular = ctk.CTkButton(frame, text='Calcular', font=text_font, text_color=background, fg_color=calcular_color, command=calculate)
        ...
        help_button = ctk.CTkButton(window, text='?', text_color=background, font=title_font, width=25, fg_color=txt_color_alt, corner_radius=90, command=self.open_help)
        ...
        iniciar_app = ctk.CTkButton(frame, text='Iniciar', fg_color=iniciar_button, font=title_font, text_color=background, width=50, height=150, corner_radius=90, command=start_program)
...
- - - - - - - - - - - - - - - - - - - - - - - - - -"""
        ...
        create_text_button = ctk.CTkButton(calculation_window, text='+', text_color=background, font=title_font, width=25, fg_color=desenhar_color, corner_radius=90, command=save_results)
...
Feito isso, pressione o botão"""
        ...
        desenhar_help = ctk.CTkButton(topframe, text='Desenhar', font=text_font, text_color=background, fg_color=desenhar_color)
...
da representação do canvas, e clicar no botão"""
        ...
        calcular_help = ctk.CTkButton(topframe, text='Calcular', font=text_font, text_color=background, fg_color=desenhar_color)
...
Na janela de resultados, há um botão"""
        ...
        create_text_button_help = ctk.CTkButton(topframe, text='+', text_color=background, font=title_font, width=25, fg_color=desenhar_color, corner_radius=90)
