...
my_icon = resource_filename(__name__, 'icon_Steel.ico')

title_font = ('Times New Roman', 35)
text_font = ('Times New Roman', 25)
credit_font = ('Times New Roman', 15)
help_font = ('Times New Roman', 15)
elements_font = ('Times New Roman', 10)
general_pady = 10
entry_width = 250
txt_color = 'white'
txt_color_alt = 'black'
...
class Caterpillar:
    def __init__(self, jan):
        ...
        help_button = ctk.CTkButton(window, text='?', text_color=txt_color, font=title_font, width=25, fg_color=txt_color_alt, corner_radius=90, command=self.open_help)
...
- - - - - - - - - - - - - - - - - - - - - - - - - -"""
        ...
        create_text_button = ctk.CTkButton(calculation_window, text='+', text_color=txt_color, font=title_font, width=25, fg_color=txt_color_alt, corner_radius=90, command=save_results)
...
Na janela de resultados, há um botão"""
        ...
        create_text_button_help = ctk.CTkButton(topframe, text='+', text_color=txt_color, font=title_font, width=25, fg_color=txt_color_alt, border_color=txt_color, border_width=1, corner_radius=90)
